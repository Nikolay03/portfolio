...
import {Moon as MoonIcon, Sun as SunIcon, Mail as MailIcon, Send} from 'react-feather'
...
const Header = (props) => {
  ...
  const toMail = 'mailto:dzuraevnikolaj49@gmail.com'
  ...
  return (
    <Wrap>
      ...
      <RightBar>
        <Email href={toMail}>dzuraevnikolaj49@gmail.com</Email>
        <a href={'https://t.me/kolya0802'}><Button><Send /></Button></a>
